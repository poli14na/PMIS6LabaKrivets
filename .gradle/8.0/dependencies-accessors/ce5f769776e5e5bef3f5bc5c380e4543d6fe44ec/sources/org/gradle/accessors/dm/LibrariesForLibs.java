...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public LibrariesForLibs(DefaultVersionCatalog config, ProviderFactory providers, ObjectFactory objects, ImmutableAttributesFactory attributesFactory, CapabilityNotationParser capabilityNotationParser) {
        ...
        /**
         * Creates a dependency provider for reimagined (dev.olshevski.navigation:reimagined)
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getReimagined() { return create("reimagined"); }
    ...
    public static class AndroidxLibraryAccessors extends SubDependencyFactory {
        ...
        public AndroidxLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
             ...
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getAnimation() { return create("androidx.animation"); }
    ...
    public static class AndroidxRoomLibraryAccessors extends SubDependencyFactory {
        ...
        public AndroidxRoomLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
             ...
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getRxjava3() { return create("androidx.room.rxjava3"); }
    ...
    public static class CoilLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        public CoilLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
             ...
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> asProvider() { return create("coil"); }
    ...
    public static class KoinLibraryAccessors extends SubDependencyFactory {
         ...
         */
        public KoinAndroidLibraryAccessors getAndroid() { return laccForKoinAndroidLibraryAccessors; }
    ...
    public static class KoinAndroidLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        public KoinAndroidLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
             ...
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> asProvider() { return create("koin.android"); }

            /**
             * Creates a dependency provider for compat (io.insert-koin:koin-android-compat)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getCompat() { return create("koin.android.compat"); }
    ...
    public static class KtorLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        public KtorLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
            ...
            /**
             * Creates a dependency provider for ktor (io.ktor:ktor)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> asProvider() { return create("ktor"); }

            /**
             * Creates a dependency provider for auth (io.ktor:ktor-auth)
             * This dependency was declared in catalog libs.versions.toml
             */
    ...
    public static class KtorSerializationKotlinxLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        public KtorSerializationKotlinxLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
             ...
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> asProvider() { return create("ktor.serialization.kotlinx"); }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        public VersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: parcelize (1.9.10)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
    ...
    public static class ComposeVersionAccessors extends VersionFactory  implements VersionNotationSupplier {
        ...
        /**
         * Returns the version associated to this alias: compose (1.6.0-beta02)
         * If the version is a rich version and that its not expressible as a
         * single version string, then an empty string is returned.
         * This version was declared in catalog libs.versions.toml
         */
    ...
    public static class Material3VersionAccessors extends VersionFactory  {
        ...
        public Material3VersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: material3.compose (1.2.0-alpha12)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
    ...
    public static class OrgJetbrainsKotlinVersionAccessors extends VersionFactory  {
        ...
        public OrgJetbrainsKotlinVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: org.jetbrains.kotlin.jvm (1.9.10)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
