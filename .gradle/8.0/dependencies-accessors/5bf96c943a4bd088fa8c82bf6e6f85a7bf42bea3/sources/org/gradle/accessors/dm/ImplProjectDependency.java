...
public class ImplProjectDependency extends DelegatingProjectDependency {
    ...
    /**
     * Creates a project dependency on the project at path ":impl:di"
     */
    public Impl_DiProjectDependency getDi() { return new Impl_DiProjectDependency(getFactory(), create(":impl:di")); }
