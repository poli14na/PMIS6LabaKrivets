...
public class ImplProjectDependency extends DelegatingProjectDependency {
    ...
    /**
     * Creates a project dependency on the project at path ":impl:presentation"
     */
    public Impl_PresentationProjectDependency getPresentation() { return new Impl_PresentationProjectDependency(getFactory(), create(":impl:presentation")); }
